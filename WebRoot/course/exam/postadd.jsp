	...
	try
		{
			...
			PreparedStatement sta = dbc.getConnection().prepareStatement("insert into exam(cno,eno,edescribe,emax,ename,exam1,exam1_perc,exam2,exam2_perc,exam3,exam3_perc,exam4,exam4_perc,exam5,exam5_perc,exam6,exam6_perc,exam7,exam7_perc,exam8,exam8_perc,exam9,exam9_perc,exam10,exam10_perc,available) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,1)");
			sta.setString(1,cno);
			sta.setString(2,eno);
			sta.setString(3,edescribe);
			sta.setString(4,emax);
			sta.setString(5,ename);
			sta.setString(6,exam1);
			sta.setString(7,exam1_perc);
			sta.setString(8,exam2);
			sta.setString(9,exam2_perc);
			sta.setString(10,exam3);
			sta.setString(11,exam3_perc);
			sta.setString(12,exam4);
			sta.setString(13,exam4_perc);
			sta.setString(14,exam5);
			sta.setString(15,exam5_perc);
			sta.setString(16,exam6);
			sta.setString(17,exam6_perc);
			sta.setString(18,exam7);
			sta.setString(19,exam7_perc);
			sta.setString(20,exam8);
			sta.setString(21,exam8_perc);
			sta.setString(22,exam9);
			sta.setString(23,exam9_perc);
			sta.setString(24,exam10);
			sta.setString(25,exam10_perc);
			sta.execute();
			sta.close();
			dbc.close();
		}
